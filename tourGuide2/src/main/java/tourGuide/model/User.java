...
import tourGuide.webClient.tripPricer.Provider;
...
public class User {
	...
	private Mono<List<Provider>> tripDeals;
	...
	public void setTripDeals(Mono<List<Provider>> tripDeals) {
		this.tripDeals = tripDeals;
	}
	
	public Mono<List<Provider>> getTripDeals() {
		return tripDeals;
	}
